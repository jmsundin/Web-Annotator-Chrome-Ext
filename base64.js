export const Base64 = {
  ...
  decode: function (str) {
    ...
    var i = 0;
    do {
      let b1 = Base64.characters.indexOf(str.charAt(i++));
      let b2 = Base64.characters.indexOf(str.charAt(i++));
      let b3 = Base64.characters.indexOf(str.charAt(i++));
      let b4 = Base64.characters.indexOf(str.charAt(i++));
